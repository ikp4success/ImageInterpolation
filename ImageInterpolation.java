...
public class ImageInterpolation {
	...
	public String BICublicInterpolation(String imageLoc, int X, int Y) {
		...
		try {
			...
			BufferedImage buffImage = graphicsConfig.createCompatibleImage(
					destWidth, destHeight, source.getColorModel()
							.getTransparency());
			...
			AffineTransform at = AffineTransform.getScaleInstance(xProportion,
					yProportion);
	...
	public String NearestNeighbour(String imageLoc, int X, int Y) {
	...
	public String BILinearInterpolation(String imageLoc, int X, int Y) {
